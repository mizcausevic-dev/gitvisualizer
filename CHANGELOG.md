...
### Released
- Released **gitvisualizer** publicly as a reviewable operating system for business operations systems.
...
### Shipped
- Cut the first coherent internal version of **gitvisualizer** with stable domain objects, review surfaces, and decision outputs.
